...
session_start();
       ...
       $getquery=mysqli_query($conn, "SELECT * FROM user WHERE username = '$username'");
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="profile-work">
                                ...
                                <a href="logout.php"><span style="color:red">Logout<span></a><br>
                                <a href="uploaduserpic.php"><span style="color:green">Upload Profie Picture<span></a>
                            </div>
                        </div>
                        <div class="col-md-8">
