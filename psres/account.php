...
<div id="container">
    ...
    <form action="account.php?update=name" method="POST">
    	First Name: <input type="text" maxlength="15" name="fName" value="<?php if(isset($_POST['fName'])) echo trim(mysqli_real_escape_string($_POST['fName'])); else echo $usersData['firstname']; ?>" />
        Last Name: <input type="text" maxlength="15" name="lName" value="<?php if(isset($_POST['lName'])) echo trim(mysqli_real_escape_string($_POST['lName'])); else echo $usersData['lastname']; ?>" /><br />
        <input type="submit" name="nameSubmit" value="Update" />
    </form>
	<?php
		if(isset($_GET['update']) && $_GET['update']=="name")
		{
			$firstName = trim(mysqli_real_escape_string($_POST['fName']));
			$lastName = trim(mysqli_real_escape_string($_POST['lName']));
    ...
    <form action="account.php?update=aboutMe" method="POST">
    	<textarea name="aboutMe" maxlength="100" rows="5" cols="30"><?php if(isset($_POST['aboutMe'])) echo trim(mysqli_real_escape_string($_POST['aboutMe'])); else echo $usersData['aboutme']; ?></textarea><br />
        <input type="submit" name="aboutMeSubmit" value="Update" />
    </form>
    <?php
		if(isset($_GET['update']) && $_GET['update']=="aboutMe")
		{
			$aboutMe = trim(mysqli_real_escape_string($_POST['aboutMe']));
    ...
    <form action="account.php?update=countryCity" method="POST">
        Country: <input type="text" maxlength="50" name="country" value="<?php if(isset($_POST['country'])) echo trim(mysqli_real_escape_string($_POST['country'])); else echo $usersData['country']; ?>" />
        City: <input type="text" maxlength="50" name="city" value="<?php if(isset($_POST['city'])) echo trim(mysqli_real_escape_string($_POST['city'])); else echo $usersData['city']; ?>" /><br />
        <input type="submit" name="countryCitySubmit" value="Update" />
    </form>
    <?php
		if(isset($_GET['update']) && $_GET['update']=="countryCity")
		{
			$country = trim(mysqli_real_escape_string($_POST['country']));
			$city = trim(mysqli_real_escape_string($_POST['city']));
    ...
    <?php
		...
		{
			$id = mysqli_real_escape_string($_POST['resetProfilePictureID']);
