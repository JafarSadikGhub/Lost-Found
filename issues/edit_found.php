...
<html>
   ...
   $(function(){
	...
	<body>
        ...
        echo "<form action='edit_found.php?ID=$ID' method='POST' enctype='multipart/form-data'>" ?>
          ...
          <div class="form-group">
						<input type="text" name="founddt" placeholder="Found Date" class="form-control">
            <input type="text" name="foundlocation" placeholder="Found Location" class="form-control">
					</div>
          <div class="form-group">
