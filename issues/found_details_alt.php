                        ...
                        <div class="col-md-4">
                            <div class="profile-img">
                              <?php
                                ...
                                $image_query=mysqli_query($conn, "select image_found1, name from found where foundId=$ID");
                                if (!$image_query) {
    printf("Error: %s\n", mysqli_error($conn));
    exit();
}
                                while($rows = mysqli_fetch_array($image_query))
                {
                    ...
                    //$img_src = $rows['img_path'];
                              ?>
                              <img src="faceRecogV4Found/labeled_images/<?php echo $name1.'/'.$img_name; ?>" class="img-responsive" height="250" width="200" /><br />
                            </div>
                            <?php
            }
        ?>
